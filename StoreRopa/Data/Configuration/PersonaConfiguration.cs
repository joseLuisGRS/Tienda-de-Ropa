...
namespace StoreRopa.Data.Configuration
{
    public class PersonaConfiguration : IEntityTypeConfiguration<Persona>
    {
        public void Configure(EntityTypeBuilder<Persona> builder)
        {
            ...
            builder.HasKey(e => e.Id).HasName("PK_persona");
            builder.Property(e => e.Id).HasComment("Identificador de la tabla");
            builder.Property(e => e.Nombres).HasColumnType("varchar(200)").IsUnicode(false)
                .HasComment("Nombre de la persona");
            builder.Property(e => e.ApPaterno).HasColumnType("varchar(100)").IsUnicode(false)
                .HasComment("Apellido paterno de la persona");
            builder.Property(e => e.ApMaterno).HasColumnType("varchar(100)").IsUnicode(false)
                .HasComment("Apellido materno de la persona");
            builder.Property(e => e.Curp).HasColumnType("varchar(18)").IsUnicode(false)
            ...
            builder.Property(e => e.Cp).IsUnicode(false)
                .HasComment("Codigo postal de su ubicación de la persona");
            builder.Property(e => e.Telefono).HasColumnType("varchar(10)").IsUnicode(false)
