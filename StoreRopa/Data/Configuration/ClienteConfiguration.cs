...
namespace StoreRopa.Data.Configuration
{
    public class ClienteConfiguration : IEntityTypeConfiguration<Cliente>
    {
        public void Configure(EntityTypeBuilder<Cliente> builder)
        {
            ...
            builder.HasOne(e => e.Persona).WithOne(p => p.Cliente).HasForeignKey<Cliente>(p => p.PersonaId)
                .HasConstraintName("FK_Persona_Cliente");
            builder.Property(e => e.Saldo).HasColumnType("DECIMAL(14,2)").IsUnicode(false)
                .HasComment("Saldo del cliente");
            builder.Property(e => e.TipoVenta).HasColumnType("int").IsUnicode(false)
